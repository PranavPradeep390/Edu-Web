      ...
      <div className='min-h-[100px] grid sm:grid-cols-12 sm:w-auto w-full'>
        ...
        <div className={`mb-5 flex-col gap-5 space-y-4 sm:space-y-0 sm:flex-row sm:space-x-10 md:justify-center justify-start items-center sm:flex ${isOpen ? 'flex' : 'hidden'} sm:block sm:p-4 sm:col-span-7`}>
          <Link to="/" onClick={closeMenu}>
            <h3 className='text-lg font-bold font_fredoka'>Home</h3>
          </Link>
          <Link to='/about' onClick={closeMenu}>
            <h3 className='text-lg font-bold font_fredoka'>About</h3>
          </Link>
          <Link to='/events' onClick={closeMenu}>
            <h3 className='text-lg font-bold font_fredoka'>Events</h3>
          </Link>
          <Link to='/gallery' onClick={closeMenu}>
            <h3 className='text-lg font-bold font_fredoka'>Gallery</h3>
          </Link>
          <Link to='/contact' onClick={closeMenu}>
            <h3 className='text-lg font-bold font_fredoka'>Contact</h3>
          </Link>
        </div>
      </div>
    </>
